...
export DURATION="300s" # time for running the profiling tool (duration for each wrk call or labench call), default value is 300s
...
export THREAD=1 # for wrk and wrk2 only, no. of threads allocated for the profiling tool, default value is 1
